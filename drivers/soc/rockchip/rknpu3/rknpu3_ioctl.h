...
/* Memory sync mode */
#define RKNPU3_MEM_SYNC_TO_DEVICE   (1UL << 0)
#define RKNPU3_MEM_SYNC_FROM_DEVICE (1UL << 1)
#define RKNPU3_MEM_SYNC_MASK        (RKNPU3_MEM_SYNC_TO_DEVICE | RKNPU3_MEM_SYNC_FROM_DEVICE)

/* Memory type */
#define RKNPU3_MEM_TYPE_DEFAULT    (0UL << 0)
#define RKNPU3_MEM_TYPE_CACHEABLE  (0UL << 1)
#define RKNPU3_MEM_TYPE_CONTIGUOUS (1UL << 0)
#define RKNPU3_MEM_TYPE_UNCACHED   (1UL << 1)
#define RKNPU3_MEM_TYPE_NON_CONTIGUOUS (1UL << 2)
#define RKNPU3_MEM_TYPE_WRITE_COMBINE  (1UL << 3)
#define RKNPU3_MEM_TYPE_KERNEL_MAPPING (1UL << 4)

#define RKNPU3_MEM_TYPE_LAYOUT_MASK \
	(RKNPU3_MEM_TYPE_CONTIGUOUS | RKNPU3_MEM_TYPE_NON_CONTIGUOUS)
#define RKNPU3_MEM_TYPE_CACHE_MASK \
	(RKNPU3_MEM_TYPE_UNCACHED | RKNPU3_MEM_TYPE_WRITE_COMBINE)
