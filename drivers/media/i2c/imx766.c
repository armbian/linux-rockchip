...
#define IMX766_LINK_FREQ_350MHZ		350000000 // 700/2
#define IMX766_LINK_FREQ_436MHZ		436000000 // 872/2
#define IMX766_LINK_FREQ_1248MHZ	1248000000 // 2496/2
/* pixel rate = link frequency * 2 * lanes / BITS_PER_SAMPLE */
#define IMX766_PIXEL_RATE_MAX		0xfffffff0
...
struct imx766 {
	...
	const struct imx766_mode *supported_modes;
	u32			cfg_num;
	u32			module_index;
 ...
 * Xclk 24Mhz
 */
static const struct regval imx766_global_30fps_regs[] = {
	{0x0100, 0x00},
	{0x0136, 0x18},
	{0x0137, 0x00},
	{0x33F0, 0x07},
 ...
 */
static const struct regval imx766_4096x2304_30fps_regs[] = {
	{0x0112, 0x0A},
	{0x0113, 0x0A},
	{0x0114, 0x03},
	{0x0342, 0xB7},
 ...
 * Xclk 24Mhz
 */
static const struct regval imx766_global_cphy_regs[] = {
	{0x0136, 0x18},
	{0x0137, 0x00},
	{0x33F0, 0x01},
	{0x33F1, 0x08},
...
static const struct regval imx766_4096x3072_cphy_regs[] = {
	{0x0112, 0x0A},
	{0x0113, 0x0A},
	{0x0114, 0x02},
	{0x0342, 0x7A},
...
static const struct regval imx766_4096x3072_30fps_cphy_regs[] = {
	{0x0112, 0x0A},
	{0x0113, 0x0A},
	{0x0114, 0x02},
	{0x0342, 0x48},
...
static const struct other_data imx766_4096x2304_spd = {
	.width = 4096,
	.height = 576,
	.bus_fmt = MEDIA_BUS_FMT_SPD_2X8,
	.data_type = 0x30,
...
static const struct imx766_mode supported_modes_dphy[] = {
	{
		...
		.hts_def = 0xB700,
		.vts_def = 0x09c4,
		.global_reg_list = imx766_global_30fps_regs,
		.reg_list = imx766_4096x2304_30fps_regs,
		.spd = &imx766_4096x2304_spd,
		.ebd = &imx766_full_ebd,
		.hdr_mode = NO_HDR,
		.vc[PAD0] = 0,
		.mipi_freq_idx = 2,
	...
	},
	{
		...
		.hts_def = 0xB700,
		.vts_def = 0x0C5C,
		.global_reg_list = imx766_global_regs,
...
static const struct imx766_mode supported_modes_cphy[] = {
	{
		.bus_fmt = MEDIA_BUS_FMT_SBGGR10_1X10,
		.width = 4096,
		.height = 3072,
		...
		.hts_def = 0x4800,
		.vts_def = 0x0d28,
		.global_reg_list = imx766_global_cphy_regs,
		.reg_list = imx766_4096x3072_30fps_cphy_regs,
		.spd = &imx766_full_spd,
		.ebd = &imx766_full_ebd,
		.hdr_mode = NO_HDR,
		.vc[PAD0] = 0,
	...
	},
	{
		...
		.vts_def = 0x0C5C,
		.global_reg_list = imx766_global_cphy_regs,
		.reg_list = imx766_4096x3072_cphy_regs,
		.spd = &imx766_full_spd,
		.ebd = &imx766_full_ebd,
		.hdr_mode = NO_HDR,
		.vc[PAD0] = 0,
...
static const s64 link_freq_menu_items[] = {
	IMX766_LINK_FREQ_350MHZ,
	IMX766_LINK_FREQ_436MHZ,
	IMX766_LINK_FREQ_1248MHZ
};
...
imx766_find_best_fit(struct imx766 *imx766,
		     struct v4l2_subdev_format *fmt)
{
	...
	for (i = 0; i < imx766->cfg_num; i++) {
		dist = imx766_get_reso_dist(&imx766->supported_modes[i], framefmt);
	...
	return &imx766->supported_modes[cur_best_fit];
}
			  ...
			  struct v4l2_subdev_format *fmt)
{
	...
	u32 lane_num = imx766->bus_cfg.bus.mipi_csi2.num_data_lanes;
	...
	if (fmt->which == V4L2_SUBDEV_FORMAT_TRY) {
		...
		*v4l2_subdev_state_get_format(sd_state, fmt->pad) = fmt->format;
		...
		__v4l2_ctrl_modify_range(imx766->vblank, vblank_def,
					 ...
					 1, vblank_def);
		dst_pixel_rate = (u64)link_freq_menu_items[mode->mipi_freq_idx] * 2 * lane_num;
		dst_pixel_rate = div_u64(dst_pixel_rate, mode->bpp);
		if (imx766->bus_cfg.bus_type == V4L2_MBUS_CSI2_CPHY) {
			dst_pixel_rate *= 228;
			dst_pixel_rate = div_u64(dst_pixel_rate, 100);
		}
				   ...
				   struct v4l2_subdev_frame_size_enum *fse)
{
	...
	fse->min_width  = imx766->supported_modes[fse->index].width;
	fse->max_width  = imx766->supported_modes[fse->index].width;
	fse->max_height = imx766->supported_modes[fse->index].height;
	fse->min_height = imx766->supported_modes[fse->index].height;
...
static long imx766_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
	...
	case RKMODULE_SET_HDR_CFG:
		...
		for (i = 0; i < imx766->cfg_num; i++) {
			if (w == imx766->supported_modes[i].width &&
			    h == imx766->supported_modes[i].height &&
			    imx766->supported_modes[i].hdr_mode == hdr_cfg->hdr_mode) {
				imx766->cur_mode = &imx766->supported_modes[i];
				break;
			}
		}
		if (i == imx766->cfg_num) {
			...
			__v4l2_ctrl_modify_range(imx766->vblank, h,
						 ...
						 1, h);
			dst_pixel_rate = (u64)link_freq_menu_items[imx766->cur_mode->mipi_freq_idx] * 2 * lane_num;
			dst_pixel_rate = div_u64(dst_pixel_rate, imx766->cur_mode->bpp);
			if (imx766->bus_cfg.bus_type == V4L2_MBUS_CSI2_CPHY) {
				dst_pixel_rate *= 228;
				dst_pixel_rate = div_u64(dst_pixel_rate, 100);
			}
			__v4l2_ctrl_s_ctrl(imx766->link_freq,
				imx766->cur_mode->mipi_freq_idx);
			__v4l2_ctrl_s_ctrl_int64(imx766->pixel_rate,
				dst_pixel_rate);
...
static int imx766_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
{
	...
	const struct imx766_mode *def_mode = &imx766->supported_modes[0];
				      ...
				      struct v4l2_subdev_frame_interval_enum *fie)
{
	...
	fie->code = imx766->supported_modes[fie->index].bus_fmt;
	fie->width = imx766->supported_modes[fie->index].width;
	fie->height = imx766->supported_modes[fie->index].height;
	fie->interval = imx766->supported_modes[fie->index].max_fps;
	fie->reserved[0] = imx766->supported_modes[fie->index].hdr_mode;
	return 0;
}
...
static int imx766_initialize_controls(struct imx766 *imx766)
{
	...
	imx766->pixel_rate = v4l2_ctrl_new_std(handler, NULL,
		V4L2_CID_PIXEL_RATE, 0, IMX766_PIXEL_RATE_MAX,
		1, dst_pixel_rate);
...
static int imx766_probe(struct i2c_client *client)
{
	...
	ret = v4l2_fwnode_endpoint_parse(of_fwnode_handle(endpoint),
					 &imx766->bus_cfg);
	if (imx766->bus_cfg.bus_type == V4L2_MBUS_CSI2_DPHY) {
		imx766->supported_modes = supported_modes_dphy;
		imx766->cfg_num = ARRAY_SIZE(supported_modes_dphy);
	} else {
		imx766->supported_modes = supported_modes_cphy;
		imx766->cfg_num = ARRAY_SIZE(supported_modes_cphy);
	}

	imx766->client = client;
	imx766->cur_mode = &imx766->supported_modes[0];
