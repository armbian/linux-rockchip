...
#define ESM_GPIO_IN_CONNECT				(0x3 << 4)
#define ESM_GPIO_IN_BOOT				BIT(0)
...
#define PKTSCHED_EMP_EXTMEM_TX_EN                       BIT(11)
...
#define HDMTX_EMP_MEM_LEN_BYPASS			BIT(13)
#define HDMTX_EMP_MEM_LEN_LEN				BIT(14)
...
#define HDMI_TX_CTRL_RK_PLUS_GRF_STATUS5		0x18114
