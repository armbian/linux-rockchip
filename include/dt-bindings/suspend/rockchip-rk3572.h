...
#ifndef __DT_BINDINGS_RK3572_PM_H__
#define __DT_BINDINGS_RK3572_PM_H__
/******************************bits ops************************************/
...
#define RKPM_SLP_PMIC_RK806		BIT(17)
...
#define RKPM_GPIO0_WKUP_EN		BIT(8)
#define RKPM_SDMMC_WKUP_EN		BIT(9)
#define RKPM_SDIO_WKUP_EN		BIT(10)
#define RKPM_USB_WKUP_EN		BIT(11)
#define RKPM_UART1_WKUP_EN		BIT(12)
#define RKPM_SFT_WKUP_EN		BIT(13)
